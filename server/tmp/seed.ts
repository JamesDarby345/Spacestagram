    ...
    const NASAImages: NASAImage[] = [
      {
        ...
        comments: ["cool pictures!", "Wow thats amazing!"],
      },
      {
        _id: new ObjectId(),
        likes: 3,
        ...
        comments: ["Really hope earth doesnt become a neutron star", "O.O"],
      },
      {
        _id: new ObjectId(),
        likes: 132,
        ...
        comments: [
          "Comet tails are pretty",
          "Hope I can see some comets this weekend!",
        ],
      },
    ];
