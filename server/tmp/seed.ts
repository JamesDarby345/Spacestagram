...
import { NASAImage, User, Comment } from "../src/lib/types";
...
const users: User[] = [
  {
    ...
    token: "token_*****",
    name: "James",
    avatar: "https://apod.nasa.gov/apod/image/2205/EclipseRays_Bouvier_960.jpg",
  },
  {
    _id: "User_2",
    token: "token_*****",
    name: "Athena",
    avatar: "https://apod.nasa.gov/apod/image/2205/FalconSun_Cain_960.jpg",
  },
  {
    _id: "User_3",
    token: "token_*****",
...
const seed = async () => {
  try {
    ...
    //     hdurl:
    //       "https://apod.nasa.gov/apod/image/0111/leo98_apodmontage_big.jpg",
    //     media_type: "image",
    //     service_version: "v1",
